...
export function HeroSection() {
  return <section id="inicio" className="hero" aria-labelledby="hero-heading">
    <div className="page-shell hero-layout">
      <div className="hero-copy"><h1 id="hero-heading" aria-label="Casanare, aquí estoy para servirte."><span className="motion-line"><span className="motion-line-inner">Casanare,</span></span><span className="motion-line"><span className="motion-line-inner">aquí estoy</span></span><span className="motion-line"><span className="motion-line-inner"><span>para servirte.</span></span></span></h1><p>Diego García. Representante a la Cámara por Casanare.</p><p className="hero-description">Una trayectoria escrita en movimiento, con el territorio en el corazón.</p><div className="hero-actions"><Link href="/#perfil" className="button button-yellow">Conoce mi historia <Icon /></Link><Link href="/#gestion" className="hero-text-link">Nuestra gestión <Icon /></Link></div><a href={siteConfig.social.whatsapp} className="hero-channel" target="_blank" rel="noopener noreferrer"><Icon name="message" /><span>Sigamos en contacto<span>Súmate al canal de WhatsApp</span></span><Icon /></a></div>
